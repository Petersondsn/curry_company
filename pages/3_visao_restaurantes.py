...
def clean_code(df1):
    ...
    df1['Delivery_person_Age'] = df1['Delivery_person_Age'].astype(str)
...
# Import Dataset
# -----------------------------------
df = pd.read_csv('ciclo_5/train.csv')
...
with tab1:
    with st.container():
        ...
        with col1:
            ...
            col1.metric('Entergadores Únicos', delivery_unique)
        ...
        with col4:
            ...
            col4.metric('Desvio Padrao Médio de Entrega com Festival', df_aux)
        ...
        with col6:
            ...
            col6.metric('Desvio Padrao Médio de Entrega com Festival', df_aux)
